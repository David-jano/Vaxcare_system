              ...
              <div class="card-body">
                <div class="d-flex justify-content-between p-md-1">
                  <div class="d-flex flex-row">
                    <div class="align-self-center">
                      <i class="far fa-file text-warning fa-3x me-4"></i>
                    </div>
                    <div>
                      <h4>Upload a file</h4>
                      <p class="mb-0"><form method="POST" enctype="multipart/form-data">
                        <input type="file" class="form-control" name="uploadfile" required/><br>
                        <input type="submit" value="Upload" name="upload" class="form-control btn btn-outline-primary col-1">
                      </p></form>
<?php
if(isset($_POST['upload'])){
                ...
                move_uploaded_file($tempname,"file_upload_download/".$filename);

                $sql = "INSERT INTO files (filename, filesize, filetype) VALUES ('$filename', $filesize, '$filetype')";
                $querrrry=mysqli_query($conn,$sql);
                if ($querrrry === TRUE) {
