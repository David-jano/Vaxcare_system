...
<button class="btn btn-secondary mb-3  dropdown-toggle"  data-bs-toggle="modal" data-bs-target="#exampleModaltrash"><i class="fas fa-trash fa-sm text-light"></i>&nbsp;&nbsp; Deletion Report</button>
</div>
...
if (mysqli_num_rows($result1) > 0) {
  echo "<table class='table table-striped'><tr><th>#</th><th>Batch No</th><th>BCG</th><th>BCG Date</th><th>Polio</th><th>Polio2(Syringe)</th><th>Polio3(Syringe)</th><th>Polio4(Syringe)</th><th>Polio Date</th></tr>";
  while ($row = mysqli_fetch_assoc($result1)) {
    echo "<tr><td>".$incremented++."</td><td>".$row['Batchno']."</td><td>".$row['Bcg_status']."</td><td>".$row['Bcg_sms']."</td><td>".$row['Status']."</td><td>".$row['Status2']."</td><td>".$row['Status3']."</td><td>".$row['Status4']."</td><td>".$row['Sms']."</td></tr>";      
  }
  echo "</table>";
} else {
