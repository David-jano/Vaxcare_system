...
<nav aria-label="...">
  <ul class="pagination pagination-sm">
    <li class="page-item" aria-current="page">
      <span class="page-link bg-success text-light"><i class="fas fa-bell me-1"></i>&nbsp;Announces</span>
    </li>
...
<strong><i class="fas fa-syringe me-1 text-lighy">&nbsp;&nbsp; </i>Vaccinate your schild since get Born</strong>
          ...
          <h4 class="text-dark mb-0">Announcements (<?php echo $aa; ?>
          )</h4>
          <div class="card">
            <div class="card-body p-2 d-flex align-items-center">
              <h6 class="text-primary fw-bold small mb-0 me-1">Announcements "ON"</h6>
 ...
 echo"<div class='card mb-3'>
          <div class='card-body'>
            <div class='d-flex flex-start'>
              <img  src='images/avatar.png' alt='avatar' width='40' height='40'/>&nbsp;
              <div class='w-100'>
                <div class='d-flex justify-content-between align-items-center mb-3'>
                  <h6 class='text-primary fw-bold mb-0'>
                    Admin
                    <span class='text-dark ms-2'>". $row['announces']."
                    </span>
                  </h6>
                  <p class='mb-0'>on &nbsp;".$row['dates']."</p>
                </div>
                <div class='d-flex justify-content-between align-items-center'>
                  <p class='small mb-0' style='color: #aaa;'>
                   • <a href='#!' class='link-grey'> View </a> •
        ...
        {
          echo"<div class='alert alert-danger'><i class='far fa-bell text-danger'></i>  No Announcements Published Yet</div>";
        }
?>
          </div>
        </div>
...
<script>
        ...
        }, 180000); // 20,000 milliseconds (20 seconds)
    </script>
