...
<nav aria-label="...">
  <ul class="pagination pagination-sm">
    <li class="page-item" aria-current="page">
      <span class="page-link bg-success text-light"><i class="fas fa-window-restore me-1"></i>&nbsp;Schedule</span>
    </li>
    <li class="page-item"><a class="page-link text-success" href="#bottom">Move &nbsp;<i class="fas fa-caret-down me-1 text-lighy">&nbsp;&nbsp; </i></a></li>
  </ul>
</nav>
<strong class="text-light"><i class="fas fa-list-alt me-1 text-light">&nbsp;&nbsp; </i>Vaccination schedule</strong>
<strong><i class="fas fa-syringe me-1 text-lighy">&nbsp;&nbsp; </i>Vaccinate your schild since get Born</strong>
          </div>
          <div class="card-body">
            
<table class="responsive-table table table-striped" style="font-size:18px;height:500px;" cell-spacing="10px">
    <tr class="bg-success"><th>#</th><th><i class="fas fa-clock list-alt me-1 text-success">&nbsp;&nbsp; </i>Time for Vaccination</th><th><i class="fas fa-syringe me-1 text-success">&nbsp;&nbsp; </i>Type of Vaccination Offered</th></tr>
    <tr><td>1</td><td>At Birth</td><td><span class="text-success">
                        <i class="fas fa-caret-down me-1"></span></i>BCG
                      <br><br>
                      <i class="fas fa-caret-down me-1 text-success "></span></i>OPV(drop)</td></tr>

    <tr><td>2</td><td>One Month and half (1/5)</td><td><span class="text-success">
                        <i class="fas fa-caret-down me-1"></span></i>OPV(Syringe 1)</td></tr>

     <tr><td>3</td><td>Two Months and half (2/5)</td><td><span class="text-success">
                        <i class="fas fa-caret-down me-1"></span></i>OPV(Syringe 2)</td></tr>

      <tr><td>4</td><td>Three Months and half (3/5)</td><td><span class="text-success">
                        <i class="fas fa-caret-down me-1"></span></i>OPV(Syringe 3)</td></tr>
                        <tr><td colspan="3"><center><br><a href="#top" class="btn btn-outline-success rounded-pill">Back to top&nbsp;&nbsp;<i class="fas fa-caret-up me-1 text-lighy"> </i></a></center></td></tr>
</table>
          </div>
        </div>
