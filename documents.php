...
<section>
  <div class="row">
        ...
        <div class="card mb-3">
          ...
          <div class="card-header py-3 d-flex justify-content-between bg-success text-light">
            <h5 class="mb-0">
<h5 class="mb-0 ">
...
<strong class="text-light"><i class="fas fa-files me-1 text-light">&nbsp;&nbsp; </i>Available Files and Documents</strong>
...
echo "<table class='table table-striped'><tr><th>File Name</th> <th>File Size</th><th>File Type</th><th>Download file</th></tr>";
...
$prepare = mysqli_query($conn, $statement);
 if (mysqli_num_rows($prepare ) > 0){
                    while ($row = $prepare ->fetch_assoc()) {
                     ...
                     echo" <tr><td>". $row['filename']."</td><td>". $row['filesize']." bytes</td><td>". $row['filetype']."</td>
                            <td><a href='". $file_path."' class='btn btn-primary' download><i class='fas fa-download me-1'></i>&nbsp;Download file</a></td></tr>";
                    ...
                    echo"<td colspan='4'>No files uploaded yet.</td>";
                }
